            ...
            <tbody>
              ...
              <tr>
                ...
                <td class= "text-center">
                  ...
                  <a href="proses_aksi.php?aksi=delete&id=<?= $row['id_artikel']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus artikel ini?')">Hapus</a>
                </td>
              </tr>
              <?php } 
                      }?>
